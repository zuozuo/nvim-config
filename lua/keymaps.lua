...
vim.keymap.set('n', 'cc', "gcc")
vim.keymap.set('x', 'cc', "gcc")
vim.keymap.set('v', 'cc', "gcc")

-- vim.keymap.set({"n", "v"}, "<leader>j", "gc", {remap = true})
vim.keymap.set({"n", "v"}, "cc", "gcc", {remap = true})  -- Use with leader n to comment n lines
...
vim.keymap.set('n', '<D-q>', '<cmd>quit<cr>', { desc = 'Quit buffer' })
vim.cmd("nmap bb :BufferGoto ")
vim.keymap.set('n', '<D-a>', 'ggVG', { desc = 'copy all' })
vim.keymap.set('i', '<D-a>', 'ggVG', { desc = 'copy all' })
...
vim.keymap.set('n', '<leader>rk', '<cmd>Lazy reload aiderPlus<cr>')
...
vim.keymap.set('n', '<D-s-h>', '<cmd>lua Snacks.notifier.show_history()<cr>')
vim.keymap.set('i', '<D-s-h>', '<cmd>lua Snacks.notifier.show_history()<cr>')
