...
map('n', '<D-l>', '<C-\\><C-n><Cmd>AvanteToggle<CR>', opts)
map('v', '<D-l>', '<C-\\><C-n><Cmd>AvanteToggle<CR>', opts)
map('t', '<D-l>', '<C-\\><C-n><Cmd>AvanteToggle<CR>', opts)
map('i', '<D-l>', '<C-\\><C-n><Cmd>AvanteToggle<CR>', opts)
