...
vim.api.nvim_create_user_command("AA", "FloatermNew --wintype=vsplit --width=0.5 zsh", {})       -- Open Aider AI assistant
...
vim.api.nvim_create_user_command("N", "FloatermNew --width=0.99 --height=0.99 nnn", {})                  -- Open nnn file manager
...
end, {})                                                                                                 -- Delete current file
vim.api.nvim_create_user_command("SnippetPython", "sp ~/.config/nvim/snippets/python/custom.json", {})     -- Edit Python snippets
vim.api.nvim_create_user_command("Ctags", "!/opt/homebrew/bin/ctags -R --fields='+n' -f .tags", {})                         -- Generate ctags
...
vim.api.nvim_create_user_command("PluginNew", function(opts)
    local filename = opts.args ~= "" and opts.args or "new_plugin.lua"
    vim.cmd("sp ~/.config/nvim/lua/plugins/" .. filename)
end, { nargs = '?' })                                                                                    -- Create new plugin file
...
vim.api.nvim_create_user_command("NN", "lua Snacks.notifier.show_history()<cr>", {})
